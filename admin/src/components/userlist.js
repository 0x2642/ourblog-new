	...
	render:function () {
		return (
          <div className="table-responsive">
            <UserTable data={this.props.data} statusColor={this.props.statusColor} />
            {this.props.showpage?<UserListBtn pagenation={this.props.pagenation} onHandleClick={this.handleClick} />:''}
          </div>
		);
	}
...
var UserListBtn = React.createClass({
  ...
  render:function () {
    return (
      <table className="table table-striped">
        <UserTableHeader />
        <UserTableBody data={this.props.data} statusColor={this.props.statusColor} />
      </table>
    );
  }
});